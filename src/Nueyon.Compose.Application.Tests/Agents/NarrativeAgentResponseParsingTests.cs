...
/// <summary>
///     Tests for NarrativeAgent response parsing and error handling.
///     Verifies that:
///     - Invalid JSON raises clear exceptions
///     - Empty content responses are rejected
///     - Null responses are rejected
/// </summary>
public sealed class NarrativeAgentResponseParsingTests
{
    /// <summary>
    ...
    private sealed class LogCapture : ILogger<NarrativeAgent>
    {
